...
const (
	...
	EthernetTypeRaw                         EthernetType = 0x7f00
)
...
func initActualTypeData() {
	...
	EthernetTypeMetadata[EthernetTypeRaw] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodeIPv4), Name: "IPv4", LayerType: LayerTypeIPv4}
