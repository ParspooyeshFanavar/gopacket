...
func TestDecodeSCTPPackets(t *testing.T) {
	...
	wantLayers := [][]gopacket.LayerType{
		...
		{LayerTypeSCTPCookieEcho, LayerTypeSCTPData, gopacket.LayerTypePayload},
		{LayerTypeSCTPCookieAck, LayerTypeSCTPSack},
		{LayerTypeSCTPData, gopacket.LayerTypePayload},
		{LayerTypeSCTPSack},
...
func TestDecodeLinkLayerDiscovery(t *testing.T) {
	...
	wantinfo := &LinkLayerDiscoveryInfo{
		...
		OrgTLVs: []LLDPOrgSpecificTLV{
			{OUI: 0x120f, SubType: 0x2, Info: []uint8{0x7, 0x1, 0x0}},
			{OUI: 0x120f, SubType: 0x1, Info: []uint8{0x3, 0x6c, 0x0, 0x0, 0x10}},
			{OUI: 0x120f, SubType: 0x3, Info: []uint8{0x1, 0x0, 0x0, 0x0, 0x0}},
			{OUI: 0x120f, SubType: 0x4, Info: []uint8{0x5, 0xf2}},
			{OUI: 0x80c2, SubType: 0x1, Info: []uint8{0x1, 0xe8}},
			{OUI: 0x80c2, SubType: 0x2, Info: []uint8{0x1, 0x0, 0x0}},
			{OUI: 0x80c2, SubType: 0x3, Info: []uint8{0x1, 0xe8, 0x10, 0x76, 0x32, 0x2d, 0x30, 0x34, 0x38, 0x38, 0x2d, 0x30, 0x33, 0x2d, 0x30, 0x35, 0x30, 0x35, 0x0}},
			{OUI: 0x80c2, SubType: 0x4, Info: []uint8{0x0}},
		},
		Unknown: nil,
	}
	...
	want8021 := LLDPInfo8021{
		PVID:               488,
		PPVIDs:             []PortProtocolVLANID{{false, false, 0}},
		VLANNames:          []VLANName{{488, "v2-0488-03-0505\x00"}},
	...
	wantinfo = &LinkLayerDiscoveryInfo{
		...
		OrgTLVs: []LLDPOrgSpecificTLV{
			{OUI: 0x120f, SubType: 0x1, Info: []uint8{0x3, 0x6c, 0x0, 0x0, 0x10}},
			{OUI: 0x12bb, SubType: 0x1, Info: []uint8{0x0, 0xf, 0x4}},
			{OUI: 0x12bb, SubType: 0x2, Info: []uint8{0x1, 0x40, 0x65, 0xae}},
			{OUI: 0x12bb, SubType: 0x3, Info: []uint8{0x2, 0x28, 0x2, 0x55, 0x53, 0x1, 0x2, 0x43, 0x41, 0x3, 0x9, 0x52, 0x6f, 0x73, 0x65, 0x76, 0x69, 0x6c, 0x6c, 0x65, 0x6, 0x9, 0x46, 0x6f, 0x6f, 0x74, 0x68, 0x69, 0x6c, 0x6c, 0x73, 0x13, 0x4, 0x38, 0x30, 0x30, 0x30, 0x1a, 0x3, 0x52, 0x33, 0x4c}},
			{OUI: 0x12bb, SubType: 0x4, Info: []uint8{0x3, 0x0, 0x41}},
		},
		Unknown: nil,
	}
	if !reflect.DeepEqual(info, wantinfo) {
	...
	wantMedia := LLDPInfoMedia{
		...
		Location: LLDPLocation{Format: LLDPLocationFormatAddress, Address: LLDPLocationAddress{
			...
			AddressLines: []LLDPLocationAddressLine{
				{LLDPLocationAddressTypeNational, "CA"},
				{LLDPLocationAddressTypeCity, "Roseville"},
				{LLDPLocationAddressTypeStreet, "Foothills"},
				{LLDPLocationAddressTypeHouseNum, "8000"},
				{LLDPLocationAddressTypeUnit, "R3L"},
			},
		}},
